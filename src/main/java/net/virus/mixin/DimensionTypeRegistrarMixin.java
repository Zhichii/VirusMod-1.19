...
public class DimensionTypeRegistrarMixin {
    ...
    public static RegistryEntry<DimensionType> initAndGetDefault(Registry<DimensionType> registry) {
        BuiltinRegistries.add(registry, DimensionTypes.OVERWORLD, new DimensionType(OptionalLong.empty(), true, false, false, true, 1.0, true, false, -128, 2048, 2048, BlockTags.INFINIBURN_OVERWORLD, DimensionTypes.OVERWORLD_ID, 0.0F, new DimensionType.MonsterSettings(false, true, UniformIntProvider.create(0, 7), 0)));
        ...
        return BuiltinRegistries.add(registry, DimensionTypes.OVERWORLD_CAVES, new DimensionType(OptionalLong.empty(), true, true, false, true, 1.0, true, false, -128, 2048, 2048, BlockTags.INFINIBURN_OVERWORLD, DimensionTypes.OVERWORLD_ID, 0.0F, new DimensionType.MonsterSettings(false, true, UniformIntProvider.create(0, 7), 0)));
    }
}
